            ...
            <div class="w-[85%] mx-auto">
                <div class="flex justify-between items-center">
                    ...
                    <form method="post" action="{{route('logout')}}" class="pt-4">
                        @csrf
                        <button
                            class="bg-[#F98538] hover:bg-[#ff9854] focus:bg-[#d16f2e] text-white text-center text-3xl py-4 px-8 mt-4 rounded-full lg:text-sm lg:px-5 lg:py-3 xl:text-md 2xl:text-lg"
